...
- [ ] T018 [US1] Document user story behavior, constraints, and operator notes in docs/[feature]-us1.md
...
- [ ] T025 [US2] Add evidence mapping for validation decisions in docs/[feature]-validation.md
...
- [ ] T031 [US3] Update graph-state visibility and hand-off notes in docs/[feature]-ui-state.md
...
- [ ] TXXX [P] Documentation updates in docs/ (required)
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Validate provider-specific behavior for AWS and Azure paths
